...
#include "header files/cartcontainer.h"
#include "header files/currentuser.h"
...
#include "header files/product_page.h"
    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->pushButton_4->setIcon(QIcon(":/new/prefix1/assets/SearchIcon.png"));
    ui->pushButton_4->setIconSize(QSize(30,30));




    ui->pushButton_10->setIcon(QIcon(":/new/prefix1/assets/logo"));
    ui->pushButton_10->setIconSize(QSize(150,120));


    ui->pushButton_11->setIcon(QIcon(":/new/prefix1/assets/profilepic.png"));
...
{
    float total = 0;
    total = (ui->label_61->text().toFloat() * (1 - (ui->label_63->text().toFloat() / 100))) + ui->label_62->text().toFloat();
...
void MainWindow::SignIn() {
    ...
    ui->label_10->setPixmap(QPixmap(":/new/prefix1/assets/login.png").scaledToWidth(600));
...
void MainWindow::on_pushButton_9_clicked()
{
    ...
    if(type == '1')
    {
        if(CurrentUser::GetCustomer()->getCart().getProducts_taken_by_user().empty()) {
            ui->pushButton_8->hide();
            ui->label_62->setText("0");
        }
        else {
            ui->pushButton_8->show();
            ui->label_62->setText("20.00");
        }
...
void MainWindow::ChangeUI()
{
    ...
    if(type == '2') {
        ...
        ui->pushButton_9->setIcon(QIcon(":/new/prefix1/assets/cart.png"));
        ui->pushButton_9->setIconSize(QSize(30,30)); 
    }
    CurrentUser::SetUser(userId, type);
}
...
{
    if(CurrentUser::GetCustomer()->getCart().checkOnCart()) {
        ui->pushButton_8->show();
        ui->label_62->setText("20.00");
    }
    else {
